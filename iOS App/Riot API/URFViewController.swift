...
class URFViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        request(.GET, "http://vowb.net:4000/URFData").responseJSON { (_, _, JSON, _) in
            if let championArray = (JSON as! NSDictionary)["champions"] as? NSArray {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("URF Cell", forIndexPath: indexPath) as! UITableViewCell
